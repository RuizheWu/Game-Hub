...
class PlayerInsightsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_player_insights, container, false)
        ...
        firebaseHelper.retrieveNewsFromDatabase("news", "Insights") { newsItemList ->
